...
class ClassificationController extends AbstractController
{
    ...
    {
        return $this->render('backend/classification/index.html.twig', [
    ...
    public function new(Request $request, ClassificationRepository $classificationRepository): Response
    {
        ...
        return $this->renderForm('backend/classification/new.html.twig', [
    ...
    {
        return $this->render('backend/classification/show.html.twig', [
            'classification' => $classification,
        ]);
    }
