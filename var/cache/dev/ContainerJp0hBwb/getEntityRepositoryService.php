...
{
    /**
     * Gets the private 'App\Repository\EntityRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntityRepository.php';

        return $container->privates['App\\Repository\\EntityRepository'] = new \App\Repository\EntityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
