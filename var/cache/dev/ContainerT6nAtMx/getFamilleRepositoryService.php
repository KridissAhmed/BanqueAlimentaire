 ...
 */
class getFamilleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FamilleRepository' shared autowired service.
     *
     * @return \App\Repository\FamilleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FamilleRepository.php';

        return $container->privates['App\\Repository\\FamilleRepository'] = new \App\Repository\FamilleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
